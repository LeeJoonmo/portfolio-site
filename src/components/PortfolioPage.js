...
_renderPermission=()=>{
    ...
    <div style={{width: '400px', margin:'auto'}}>
      <form onSubmit={this._handleSubmit}>
          ...
          <input
            ...
            style={{width: 400, height: 100, fontSize: 20, paddingLeft: 100, }}
            />
            <div>
        <button type="submit" value="Submit" style={{width: 400, paddingTop: '20px',paddingBottom: '20px', border :'none', marginTop: '30px', fontSize:16,borderRadius:'3px', backgroundColor: "#3A4861", color: 'white'}}>확인</button>
        </div>
      </form>
      </div>
    </div>
  ...
  render() {
    ...
    return(
      ...
      this.state.permission? this._renderPortfolio() : this._renderPermission()
